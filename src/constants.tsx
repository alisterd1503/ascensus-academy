import { NavItem, Tutor, Subjects, Pricing, Contact, EmailJS, Founder, HomePage, AboutPage, FeatureSection, TutorSection } from './types';
...
export const TUTORSECTION: TutorSection = {
